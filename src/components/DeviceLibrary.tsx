...
export function DeviceLibrary({
  ...
  const [portConnectorCategory, setPortConnectorCategory] = useState<ConnectorCategory>(defaultConnectorCategory)
  const [portConnectorType, setPortConnectorType] = useState(defaultConnectorType)
  ...
  const [editingPortConnectorCategory, setEditingPortConnectorCategory] = useState<ConnectorCategory>(defaultConnectorCategory)
  const [editingPortConnectorType, setEditingPortConnectorType] = useState(defaultConnectorType)
  ...
  const [bulkConnectorCategory, setBulkConnectorCategory] = useState<ConnectorCategory>(defaultConnectorCategory)
